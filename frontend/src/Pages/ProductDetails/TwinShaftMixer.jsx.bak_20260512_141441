              ...
              <div className="space-y-6">
                <div className="bg-yellow-50 p-6 rounded-xl border-2 border-[#FECC00]">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-center text-gray-700">
                      <FaCheck className="mr-3 text-[#FECC00]" /> Advanced PLC
                      Control System
                    </li>
                    <li className="flex items-center text-gray-700">
                      <FaCheck className="mr-3 text-[#FECC00]" /> High-Grade
                      Steel Construction
                    </li>
                    <li className="flex items-center text-gray-700">
                      <FaCheck className="mr-3 text-[#FECC00]" /> Efficient
                      Hydraulic Cooling
                    </li>
                    <li className="flex items-center text-gray-700">
                      <FaCheck className="mr-3 text-[#FECC00]" /> Automated
                      Operation System
                    </li>
                  </ul>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <button
                    ...
                    className="flex-1 flex items-center justify-center px-6 py-4 border-2 border-[#FECC00] text-gray-900 rounded-xl hover:bg-yellow-50 transition-colors font-semibold"
                  >
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    <p className="text-gray-600 leading-relaxed">
                      The Twin Shaft Concrete Mixer represents the pinnacle of
                      mixing technology, designed for optimal performance in
                      demanding industrial environments. Its innovative
                      twin-shaft design ensures thorough and uniform mixing of
                      materials.
                    </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <p className="text-gray-600">
                  Interested in our Twin Shaft Concrete Mixer? Contact us for
              ...
              <div className="space-y-4">
                <ContactForm type="contact" className="product-contact-form" />
              </div>
            </div>
          </div>
        </motion.div>
